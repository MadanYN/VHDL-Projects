...
-- Equation(s):
-- \add_instance|state\(2) = DFFEAS((\add_instance|state\(1) $ (\add_instance|state\(0) $ (\add_instance|state\(2)))), GLOBAL(\input_vector~combout\(0)), !GLOBAL(\input_vector~combout\(1)), , , , , , )
...
PORT MAP (
	...
	datab => \add_instance|state\(1),
	datac => \add_instance|state\(0),
...
-- Equation(s):
-- \add_instance|state\(1) = DFFEAS(((\add_instance|state\(2) & (\add_instance|state\(0) & \add_instance|state\(1))) # (!\add_instance|state\(2) & ((!\add_instance|state\(1))))), GLOBAL(\input_vector~combout\(0)), !GLOBAL(\input_vector~combout\(1)), , , , , 
-- , )
...
-- Equation(s):
-- \add_instance|state\(0) = DFFEAS(((\add_instance|state\(0) & ((!\add_instance|state\(2)))) # (!\add_instance|state\(0) & (!\add_instance|state\(1) & \add_instance|state\(2)))), GLOBAL(\input_vector~combout\(0)), !GLOBAL(\input_vector~combout\(1)), , , , , 
-- , )
