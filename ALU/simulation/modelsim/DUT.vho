...
-- Equation(s):
-- \add_instance|op[1]~1_combout\ = (\input_vector~combout\(9) & (!\input_vector~combout\(8) & (\input_vector~combout\(5) $ (\input_vector~combout\(1))))) # (!\input_vector~combout\(9) & (\input_vector~combout\(1) $ (((\input_vector~combout\(5) & 
...
-- Equation(s):
-- \add_instance|op[2]~2_combout\ = (\input_vector~combout\(8) & (!\input_vector~combout\(9) & (\input_vector~combout\(6) $ (\input_vector~combout\(2))))) # (!\input_vector~combout\(8) & (\input_vector~combout\(2) $ (((\input_vector~combout\(6) & 
-- \input_vector~combout\(9))))))
...
-- Equation(s):
-- \add_instance|op[3]~3_combout\ = (\input_vector~combout\(9) & (!\input_vector~combout\(8) & (\input_vector~combout\(3) $ (\input_vector~combout\(7))))) # (!\input_vector~combout\(9) & (\input_vector~combout\(3) $ (((\input_vector~combout\(8) & 
...
-- Equation(s):
-- \add_instance|op[4]~4_combout\ = (!\input_vector~combout\(8) & (((\input_vector~combout\(4) & !\input_vector~combout\(9)))))
...
-- Equation(s):
-- \add_instance|op[5]~5_combout\ = ((\input_vector~combout\(5) & (!\input_vector~combout\(8) & !\input_vector~combout\(9))))
...
-- Equation(s):
-- \add_instance|op[6]~6_combout\ = (\input_vector~combout\(6) & (((!\input_vector~combout\(8) & !\input_vector~combout\(9)))))
...
-- Equation(s):
-- \add_instance|op[7]~7_combout\ = (!\input_vector~combout\(9) & (((!\input_vector~combout\(8) & \input_vector~combout\(7)))))
